...
4. **Trabajos.** Cuatro proyectos. Dos son visitables: la calculadora de Costeador 3D y la tienda de impresiones 3D — se abren en pestaña nueva. Los otros dos se muestran solo como imagen, porque son de clientes o están protegidos con clave.
...
- El sitio **se adapta al tema del sistema**: claro por defecto, oscuro si así está configurado el dispositivo.
...
Buscar `PLACEHOLDER` en `index.html`: marca lo pendiente. Hoy quedan las capturas de dos trabajos y los rangos de precio.
...
- **No agregar recursos externos** (fuentes, CDN, imágenes remotas): romperían la carga rápida y la promesa de no cargar nada de terceros.
